...
4. [모든 DAO-consortium에서는, '제안-투표-반영'의 구성원간 합의과정을 거쳐 의사가 결정됩니다.](https://github.com/baekya-protocol/baekya-protocol/docs/protocol_overview.md#p-token-political-token)
...
3. 모든 DAO-consortium에서는, '제안-투표-반영'의 구성원간 합의과정을 거쳐 의사가 결정됩니다.
   - 제안: 모든 구성원은 1P이상을 담보로 지불하여 안건을 제안할 수 있으며, DAO 내 전체 구성원의 1%만큼의 P-token(최소 1P)이 모이면 투표과정으로 진입합니다. (2주 내로 투표진입 실패시 제안은 소각되고, 담보P는 돌려받습니다.)
   - 투표: 구성원은 0.1P를 대가로 찬성, 반대, 기권중 한가지를 선택할 수 있으며, 2주 내로 정족수가 DAO 내 전체 구성원의 40%를 만족하면 투표는 즉시 종료됩니다. 
     - 기권을 제외한 찬성표가 50%이상인 경우에만 제안이 통과되며, 담보P를 돌려받게 됩니다.
     - 그 외의 모든 경우에서는 안건과 담보P 모두 소각됩니다. (정족수 실패, 기권 + 반대 50%이상)
   - 반영: 통과된 안건은 DAO 내 운영DAO인 Ops-DAO에게 이송되며, 거부되거나 반영됩니다.
     - Ops-DAO는 
