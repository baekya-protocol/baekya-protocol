...
4. [모든 DAO-consortium에서는, '제안-투표-검토'의 구성원간 합의과정을 거쳐 의사가 결정 및 반영됩니다.](https://github.com/baekya-protocol/baekya-protocol/blob/main/docs/protocol_overview.md#governance)
...
5. OP-Governance 구조
   ...
   - OP의 권한은 거부/제안/반영 이며, 토큰 및 제한없이 가능합니다. (지지율 감소에 따라 탄핵안이 구성원에게 자동 제안되므로 권한행사에 성실과 신중을 기울여야 합니다.)
   - P-token의 발행일 마다 '현 OP 지지여부' 설문이 DAO 구성원에게 자동 제안되며, 2일 경과시 자동 종료됩니다.
   - 설문에 따라 지지율이 40%미만이 되면 DAO 구성원에게 'OP 탄핵안'이 자동 제안됩니다. OP 탄핵투표는 2일간 진행되며, 토큰소모 없이 찬성/반대중 한가지를 선택할 수 있습니다.
   ...
   - 찬성표가 60%미만인 경우 탄핵안은 소각되며, 'P-token의 발행일 마다 지지율 설문-> 40%미만시 탄핵안 자동 제안, 투표'과정이 반복됩니다.
