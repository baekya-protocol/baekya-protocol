...
(기여증명 화폐발행은 '기여에 대한 분배권 및 생존권 보장'의 의미이며, 자유시장활동에서의 노동임금과는 별개의 개념입니다.)
...
2. B-token으로 지불된 트랜잭션 수수료(TF)의 일부는 검증자 풀(Validation Pool)에 사용되어 네트워크 안정성을 확보하며, 또 다른 일부는 구성원간 합의에 의해 사용될 DAO금고(DAO-treasury)에 예치됩니다.
